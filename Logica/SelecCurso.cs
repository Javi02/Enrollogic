...
namespace Logica
{
    public class SelecCursoLog
    {
        ...
        public void verSelecCurso()
        {
            ...
            {
                selecCursos = conn.Query<SelecCurso>("Select id, estudiante, dia, hora, cede  from SelecCurso;").ToList();
            }
        }
        ...
        public void actualizarSelecCurso(int Estudiante, List<SelecCurso> selecCursos)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                ...
                sql = "insert into [Matricula].[dbo].SelecCurso  ([id], [estudiante], [dia] , [hora] , [cede]) VALUES (@id, @estudiante, @dia,@hora, @cede)";
